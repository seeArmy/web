...
<script type="text/ecmascript-6">
  ...
  import { getColumn, list, getSearch, deleted, exportCsv, add, downloadErrorData, downloadTemplate, getDetail } from '../../api/AccidentService';
  ...
  export default {
    ...
    data: () => {
      return {
        ...
        getSearch,
        objectName: '事故',
        addUrl: '/accident/add.html',
        editUrl: '/accident/add.html',
        listUrl: '/accident/list.html',
        deleteFun: deleted,
        exportCsv,
        add,
        downloadErrorData,
        importUrl: `${ApiConst.apiMaintenaceDomain}/import/custom/accident`,
        downloadTemplate
      };
    },
    methods: {
