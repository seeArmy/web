    ...
    <div class="logistics-section">
      <ul class="fm-list">
        <li>
          ...
          <span class="fm-cont">
            <a :href="`/logistics/add.html?code=${logisticsData.code}&editable=false`" target="_blank" class="blue">
          ...
          <bm-info-window
            ...
            <div class='rl-map-info'>
              ...
              <div class='map-header'>
                ...
                <a class="truck-detail blue" :href="`/truck/add.html?truckCode=${markerPoint.truck.platformTruckCode}&editable=false`" target="_blank">{{ markerPoint.truck.truckLicenseNo }}</a> - <a class="truck-detail blue" :href="`/trailer/add.html?code=${markerPoint.truck.trailerTruckCode}&editable=false`" target="_blank">{{ markerPoint.truck.trailerTruckLicenseNo }}</a>
              ...
              <div class='map-content'>
                ...
                <ul class="wb-list" v-show="markerPoint.showWaybill">
                  <li>
                    ...
                    <a class="blue" :href="`/waybill/add.html?code=${markerPoint.truck.code}&editable=false`" target="_blank">{{ markerPoint.truck.waybillNo }}</a>
                  </li>
                </ul>
      ...
      <div class="waybill-list">
        ...
        <div class="card-list" :class="[waybill.isActive ? 'actived' : '']" v-for="(waybill, index) in waybillData" :key="waybill.id" @click="openTruckPop(waybill, 'fromWaybill')">
          <div class="cl-hd">
            ...
            <!-- <a :href="`/waybill/add.html?code=${waybill.code}&editable=false`" target="_blank" class="blue"> -->
          ...
          <div class="cl-bd">
            <p>
              ...
              <a :href="`/truck/add.html?truckCode=${waybill.platformTruckCode}&editable=false`" target="_blank" class="blue">
...
import { getWaybillList, getPopWaybillList, getTotal } from '../../api/waybillService';
