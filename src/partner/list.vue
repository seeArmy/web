...
<script type="text/ecmascript-6">
  ...
  import { getColumn, list, getSearch, deleted, exportCsv, add, downloadErrorData, downloadTemplate ,getDetail, tagList, addTag, editTag, deleteTag } from '../../api/PartnerService';
  ...
  export default {
    ...
    data: () => {
      return {
        ...
        getSearch,
        objectName: '伙伴',
        addUrl: '/partner/add.html',
        editUrl: '/partner/add.html',
        listUrl: '/partner/list.html',
        deleteFun: deleted,
        exportCsv,
        add,
        downloadErrorData,
        importUrl: `${ApiConst.apiOrgDomain}/import/custom/partner`,
        downloadTemplate,
