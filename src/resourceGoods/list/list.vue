...
<script type="text/ecmascript-6">
  ...
  import { getColumnGoods, listGoods, getSearchGoods,deletedGoods } from '../../../api/goodsCategoryService';
  ...
  export default {
    ...
    data: () => {
      return {
        ...
        loading: true,
        list:listGoods,
        getColumn:getColumnGoods,
        getList: listGoods,
        getSearch:getSearchGoods,
        deleteList:deletedGoods,
        objectName: '货物',
        downloadErrorData: Function,
        downloadTemplate: Function,
        importUrl: `${ApiConst.apiResourceDomain}/import/custom/rates`,
        exportCsv: Function,
        editUrl: '/resourceGoods/add.html',
