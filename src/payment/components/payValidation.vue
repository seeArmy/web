<template>
  <div id="payValidation" class="form-page">
    <el-row>
      <div class="block block-box">
        <h2 class="page-title">支付平台</h2>
        ...
        <el-form :model="domainObject" ref="domainObject" label-width="150px" :inline="false" :label-position="'right'" >
          <div class="block block-box">
            ...
            <el-row v-if="processing && processIndex === processLength">
              ...
              <el-table :data="processRes" style="width: 100%">
                <el-table-column type="index" label="序号" width="100"> </el-table-column>
                <el-table-column v-for="(item, index) in tableField" :key="index" :label="item.label" min-width="120">
