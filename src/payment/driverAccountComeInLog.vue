...
import { getMoneyFlowForDriver as cashflowLst } from '../../api/virtualAccount'
import { getParamsFromURL } from '../../api/Utils'
import { downloadCsv } from '@/utils/downloadFile';

  export default {
    name: 'driver-cash-come-in',
    components: {
      'listLayout': listLayout
    },
    data: () => {
      return {
        objectName: '司机会员出入金记录',
        cashflowLst,
        addUrl: '',
        editUrl: '',
        extraParams: {
    ...
    methods: {
      handleExportCsv(params) {
        ...
        const api = 'pay/virtualAccount/export/moneyFlowForDriver'
