...
<script type="text/ecmascript-6">
  ...
  import { edit, add, get } from '../../api/BankAccountService';
                ...
                content: [
                  {
                    ...
                    elementCode: 'text',
                    extraParams: '{"field1": "bankAccountName", "placeholder1":"请输入银行户名", "required": "true"}'
                  },
                  {
                    showName: '开户行',
                    fieldConfigCode: 'bankName',
                    elementCode: 'text',
                    extraParams: '{"field1": "bankName", "placeholder1":"请输入开户行", "required": "true"}'
                  },
                  {
                    showName: '银行账号',
                    fieldConfigCode: 'bankAccountNo',
                    elementCode: 'text',
                    extraParams: '{"field1": "bankAccountNo", "placeholder1":"请输入银行账号", "required": "true"}'
                  },
                  {
                    showName: '描述',
...
//          console.log(paramData);
          ...
          if (urlCode || urlEditable) {
            ...
            if (orgCode) {
              self.domainObject.orgCode = orgCode;
            }
            if (personCode) {
