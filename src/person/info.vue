        ...
        <div class="basic-info-list" v-show="isShow === false">
          <ul class="text-list">
              ...
              <li>
                ...
                <span class="value">
                  {{ editParams.gender ? (editParams.gender === 'male' ? '男' : '女') : '' }}
                </span>
              </li>
              <!-- <li>
            ...
            <el-row>
              ...
              <!-- <el-col :span="24">
                <el-form-item label="部门" prop="deptCode">
                  <dpTreeSelect v-model="ruleForm.deptCode" /></dpTreeSelect>
                </el-form-item>
              </el-col>
              <el-col :span="24">
                <el-form-item label="角色类型" prop="roleName">
                  <el-checkbox-group v-model="ruleForm.roleCodeList">
                      <el-checkbox :label="item.code" v-for="item in showRoleList" :key="item.code" :disabled="item.showtype">{{ item.roleName }}</el-checkbox>
                  </el-checkbox-group>
                </el-form-item>
              </el-col> -->
            </el-row>
...
import { getDept as employeeGetDept, getRole as employeeGetRole } from '../../api/EmployeeService';
