...
<script type="text/ecmascript-6">
  ...
  import { getColumn, list, getSearch, deleted, exportCsv, add, downloadErrorData, downloadTemplate, getDetail } from '../../api/InsuranceService';
  ...
  export default {
    ...
    data: () => {
      return {
        ...
        getSearch,
        objectName: '保险记录',
        addUrl: '/insurance/add.html',
        editUrl: '/insurance/add.html',
        listUrl: '/insurance/list.html',
        deleteFun: deleted,
        exportCsv,
        add,
        downloadErrorData,
        importUrl: `${ApiConst.apiMaintenaceDomain}/import/custom/insurance`,
        downloadTemplate
      };
    },
    methods: {
