...
<template>
  <div class="block" :class="['complex-control-' + field.extraParams.length]">
    ...
    <ele-quote
     ...
     <ele-goods-loss-more
      v-else-if="field.elementCode === 'goodsLossTypeMore'"
      :quoteData="field.extraParams"
      :domainObject="domainObject"
      :isList="isList"
      :editable="editable">
    ...
    <ele-config
      v-else
      :domainObject="domainObject"
      @setOutputKeyEvent = 'setOutputKeyEvent'
      :field="param"
      :inputKey="inputKey"
      :editable="editable"
      :isList="isList"
...
<script type="text/ecmascript-6">
  ...
  import eleGoodsLossMore from '../ele-goods-loss-more/eleGoodsLossMore.vue';
  ...
  export default {
    ...
    components: {
      ...
      'ele-goods-loss-more': eleGoodsLossMore,
      eleSelectDriver
    },
    methods: {
