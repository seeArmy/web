...
<template>
  <el-form :inline="true" :model="searchModel" ref="searchModel" class="demo-form-inline">
    <el-form-item v-if="(isMin && index < miniSearchNum) || !isMin" v-for="(searchField, index) in searchFields" :key="searchField.fieldConfigCode">
...
<script type="text/ecmascript-6">
  import eleBlock from '@/components/ele-block/eleBlock';
