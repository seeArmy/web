...
import * as PlatformBankAccountService from '../../api/PlatformBankAccountService';
...
export default {
  ...
  data() {
    return {
      ...
      fields: Array,
      inputKey: Array,
      addFun: PlatformBankAccountService.add,
      editFun: PlatformBankAccountService.edit,
      getInfo: PlatformBankAccountService.get,
      uploadUrl: ApiConst.apiPlatformDomain,
      logType: 'driver-account',
      listUrl: '/driverManagement/account-list.html',
      listTitle: '司机银行账号管理'
    };
  },
  methods: {
