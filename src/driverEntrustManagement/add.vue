...
<template>
  <div>
    <div class="form-page">
      <ele-form :domainObject="domainObject" ref="domainObject" :configUrl="configUrl" :listUrl="listUrl" :listTitle="listTitle" :getInfo="getInfo" :addFun="addFun" :editFun="editFun" :editable="editable" :isEdit="isEdit" @formReady="formReady" @editSuccess="editSuccess" @submitDone="submitDone" @formMounted="formMounted" :objectName="objectName" label-width="100px" :inline="false">
...
import { add, edit,getDriverEntrust as get, editBank, verify } from '../../api/DriverMemberService';
...
export default {
  ...
  data() {
    return {
      objectName: '司机委托收款',
      code: '',
      configUrl: `${ApiConst.apiPlatformDomain}/detail_render_info/driverEntrust/list`,
      domainObject: {},
      editable: true,
      isEdit: false,
      btnDisabled: false,
