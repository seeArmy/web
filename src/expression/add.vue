...
<script type="text/ecmascript-6">
  ...
  import { edit, add, get } from '../../api/ExpressionService';
              ...
              data: {
                content: [
                  ...
                  },
                  {
                    ...
                    elementCode: 'text',
                    extraParams: '{"field1": "expressionName", "required": "true"}'
                  },
                  {
                    showName: '公式代码',
                  ...
                  {
                    showName: '输出字段',
                    fieldConfigCode: 'expressionResultFieldName',
                    elementCode: 'text',
                    extraParams: '{"field1": "expressionResultFieldName", "required": "false"}'
                  },
                  {
                    showName: '公式备注',
                  ...
                  {
                    showName: '公式内容',
                    fieldConfigCode: 'expressionContent',
                    elementCode: 'textarea',
                    extraParams: '{"field1": "expressionContent", "required": "false"}'
                  }
                ]
              }
            },
