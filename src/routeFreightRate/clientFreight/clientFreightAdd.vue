...
export default {
  ...
  data() {
    return {
      objectName: '客户运价',
      configUrl: `${ApiConst.routeFreightRate}/detail_render_info/clientFreight/list`,
      domainObject: {},
      addFun: routeFreightRateService.addClientFreightDetail,
      editFun: routeFreightRateService.editClientFreightDetail,
      getInfo: routeFreightRateService.getClientFreightDetail,
      uploadUrl: ApiConst.apiCrane,
      logType: 'clientFreight',
      listUrl: '/routeFreightRate/clientFreight/clientFreightList.html',
      listTitle: '客户运价单',
      status: false,
      code: '',
      fields: [],
