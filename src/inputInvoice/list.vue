...
<script type="text/ecmascript-6">
  ...
  import { getColumn, list, getSearch, deleted, exportCsv, add, downloadErrorData, downloadTemplate, invoiced, audit } from '../../api/InputInvoiceService';
  ...
  export default {
    ...
    data: () => {
      return {
        ...
        getSearch,
        objectName: '进项发票',
        addUrl: '/inputInvoice/add.html',
        editUrl: '/inputInvoice/add.html',
        listUrl: '/inputInvoice/list.html',
        deleteFun: deleted,
        exportCsv,
        add,
        downloadErrorData,
        importUrl: `${ApiConst.apiSettleDomain}/import/custom/input_vat_invoice`,
        downloadTemplate,
