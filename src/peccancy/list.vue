...
<script type="text/ecmascript-6">
  ...
  import { getColumn, list, getSearch, deleted, exportCsv, add, downloadErrorData, downloadTemplate, getDetail } from '../../api/PeccancyService';
  ...
  export default {
    ...
    data: () => {
      return {
        ...
        getSearch,
        objectName: '违章记录',
        addUrl: '/peccancy/add.html',
        editUrl: '/peccancy/add.html',
        listUrl: '/peccancy/list.html',
        deleteFun: deleted,
        exportCsv,
        add,
        downloadErrorData,
        importUrl: `${ApiConst.apiMaintenaceDomain}/import/custom/peccancy`,
        downloadTemplate
      };
    },
    methods: {
