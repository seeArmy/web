...
import { getDriverSettleCollectionColumn as getColumn, getDriverSettleCollectionList as list, getDriverSettleCollectionSearch as getSearch, exportDriverSettleCollectionSummaryCsv as exportCsv } from '../../api/ReportService';
...
export default {
  ...
  data: () => {
    return {
      folder: 'report/driverSettleCollection',
      listData: [],
      total: 0,
      loading: true,
      getColumn,
