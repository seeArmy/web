...
<script type="text/ecmascript-6">
  ...
  import { getColumn, list, getSearch, deleted, exportCsv, add, downloadErrorData, downloadTemplate } from '../../api/DeviceService';
  ...
  export default {
    ...
    data: () => {
      return {
        ...
        getSearch,
        objectName: '车辆绑定',
        addUrl: '/device/add.html',
        editUrl: '/device/add.html',
        listUrl: '/device/list.html',
        deleteFun: deleted,
        exportCsv,
        add,
        downloadErrorData,
