...
<script type="text/ecmascript-6">
  ...
  import { addGoodsCategory as ratesAdd, editGoodsCategory as ratesEdit, getGoodsCategory as ratesGet } from '../../../api/goodsCategoryService';
  ...
  export default {
    ...
    data() {
      return {
        objectName: '货物分类',
        configUrl: `${ApiConst.apiResourceDomain}/detail_render_info/resourceGoodsCategory/list`,
        domainObject: {},
        addFun: ratesAdd,
        editFun: ratesEdit,
        getInfo: ratesGet,
