    ...
    <el-form :model="domainObject" ref="domainObject" :rules="rules" label-width="140px" :inline="false">
      <el-row :gutter="20">
        <el-col :span="12" class="el-col-auto">
          ...
          <el-form-item label="使用单位" prop="orgName" class="is-required">
            <el-autocomplete
          ...
          <el-form-item label="设备名称" prop="deviceName">
            <el-input v-model="domainObject.deviceName" placeholder="请输入设备名称" v-if="editable || !isEdit"></el-input>
            <span v-else>{{domainObject.deviceName}}</span>
          </el-form-item>
          <el-form-item label="设备编号" prop="deviceCode">
            <el-input v-model="domainObject.deviceCode" placeholder="请输入设备编号" v-if="editable || !isEdit"></el-input>
...
//        cb(results);
        orgList({orgFullName: queryString, size: 20}, (success) => {
          this.orgList = success.content;
          this.orgList.forEach((val) => {
            val.value = val.orgFullName;
          });
