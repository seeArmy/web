...
<script type="text/ecmascript-6">
  ...
  import { getDetail, getColumn, list, getSearch, deleted, exportCsv, add, downloadErrorData, downloadTemplate } from '../../api/TyreService';
  ...
  export default {
    ...
    data: () => {
      return {
        ...
        getSearch,
        objectName: '车辆轮胎',
        addUrl: '/tyre/add.html',
        editUrl: '/tyre/add.html',
        listUrl: '/tyre/list.html',
        deleteFun: deleted,
        exportCsv,
        add,
        downloadErrorData,
        importUrl: `${ApiConst.apiMaintenaceDomain}/import/custom/tyre`,
