/**
* add.vue
* Created by mayangyang on 18/3/30.
*/
<template>
  <div>
    <div class="form-page">
...
<script type="text/ecmascript-6">
  ...
  import { add, edit, get } from '../../api/AppVersionService';
  ...
  export default {
    ...
    data() {
      return {
        objectName: 'app版本管理',
        configUrl: `${ApiConst.apiDiverApiDomain}/detail_render_info/version/list`,
        domainObject: {},
        addFun: add,
        editFun: edit,
        getInfo: get,
        uploadUrl: ApiConst.apiDiverApiDomain,
        logType: 'device',
