    ...
    <div class="section">
	    ...
	    <div class="el-row">
	    	<div class="el-col el-col-12">
	    		<slot name="contractNo"></slot>
	    	</div>
	    	<div class="el-col el-col-12">
	    		<slot name="contractName"></slot>
	    	</div>
	    	<div class="el-col el-col-12">
	    	...
	    	<div class="el-col el-col-12" v-show="isEdit && !editable">
	    		<slot name="contractStatus"></slot>
	    	</div>
	    	<div class="el-col el-col-12">
	    		<slot name="contractExpiryDate"></slot>
	    	</div>
	    	<div class="el-col el-col-12 contract-desp">
	    		<slot name="description"></slot>
	    	</div>
	    	<!-- 合同编号 不可编辑 -->
	        <div class="el-col el-col-6" v-show="isEdit && !editable">
	    		<slot name="contractSystemNo"></slot>
	    	</div>

	    	<div class="el-col el-col-24 el-col-description">
	    		<slot name="contractDetail"></slot>
	    	</div>
	    	<div class="el-col el-col-24 el-col-auto">
	    		<slot name="contractAttachment"></slot>
	    	</div>
	    	<div class="el-col el-col-6" v-show="isEdit && !editable">
