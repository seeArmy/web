...
<script type="text/ecmascript-6">
  ...
  import { getDetail, getColumn, list, getSearch, deleted, exportCsv, add, downloadErrorData, downloadTemplate } from '../../../api/RouteService';
  ...
  export default {
    ...
    data: () => {
      return {
        ...
        getSearch,
        objectName: '线路',
        addUrl: '/route/add.html',
        editUrl: '/route/add.html',
        listUrl: '/route/list.html',
        deleteFun: deleted,
        exportCsv,
        add,
        downloadErrorData,
        importUrl: `${ApiConst.apiLineDomain}/import/custom/route`,
        downloadTemplate,
