  ...
  <div class="truck-add">
    ...
    <el-tabs type="border-card" slot="moreRecords" v-if="isEdit">
      ...
      <el-tab-pane label="运单记录">
        <waybill :selectable="false" :operatable="false" :customColumn="customColumnWaybill" :isAdvanced="false" :params="params" :needPage="false" :needMore="true" :showRecycle='false' :showBatchFixPrice='false'></waybill>
      </el-tab-pane>
...
export default {
  ...
  methods: {
    ...
    formMounted(form) {
      ...
      getDetail((success) => {
        const data = success.content;
        this.defaultDetailColumns = [];
        this.actualDetailColumns = [];
        this.clientDetailColumns = [];
    ...
    formReady(formData) {
      ...
      this.unVerify = (this.domainObject.certStatus === 'unauthenticated' || this.domainObject.certStatus === 'failed') && this.domainObject.isTrailer === 'false';
      if (this.isEdit) {
    ...
    loadTrailerConfig() {
      this.trailerfields = [{
        ...
        },
        {
          "elementCode": "text",
          "showName": "识别代号",
          "fieldConfigCode": "truckIdentifyCode",
          "extraParams": [{
            "controlType": "text",
            "field": "truckIdentifyCode"
          }]
        },
        {
          "elementCode": "regTonnage",
          "showName": "总质量",
          "fieldConfigCode": "truckTotalWeight",
          "extraParams": [{
              "controlType": "text",
              "field": "truckTotalWeight"
            },
            {
              "controlType": "select",
              "field": "truckTotalWeightUnitCode",
        ...
        },
        {
          "elementCode": "regTonnage",
          "showName": "整备质量",
          "fieldConfigCode": "truckCurbWeight",
          "extraParams": [{
              "controlType": "text",
              "field": "truckCurbWeight"
            },
            {
              "controlType": "select",
              "field": "truckCurbWeightUnitCode",
              "datasource": "truckCarry",
              "default": "kg"
            }
          ]
        ...
        },
        {
          "elementCode": "date",
          "showName": "注册日期",
          "fieldConfigCode": "truckRegisterDate",
          "extraParams": [{
            "controlType": "date",
            "field": "truckRegisterDate"
          }]
        },
        {
          "elementCode": "text",
  ...
  mounted() {
    const self = this;
    window.matchTruckInfoNow = function() {
      console.log('matchTruckInfoNow');
    ...
    setTimeout(() => {
      ...
      if (ele) {
        ele.setAttribute('onblur', 'matchTruckInfoNow()');
      }
    }, 1000);
  }
};
