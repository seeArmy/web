...
<!--       <div class="truck-location fl" v-if="isEdit && hasLocation">
    ...
    <div class="section">
      ...
      <div class="el-row col-ident">
        ...
        <div class="el-col el-col-6">
          ...
          <!-- </div> -->
          <!-- <div class="el-col el-col-6" v-if='editable'>
        ...
        <!-- 车辆种类 -->
        <div :class="showAddFields ? 'el-col el-col-6' : 'el-col el-col-12'">
        ...
        <div class="el-col el-col-6 col-spe" v-if="showAddFields">
        ...
        <!--车辆所有人  -->
        <div class="el-col el-col-12" v-if="showAddFields">
    ...
    <div class="section" v-if="isEdit">
      ...
      <div class="el-row" v-if="isEdit && !editable">
        <!-- 创建人 -->
        <div class="el-col el-col-6">
    ...
    <div class="form-button" v-if='editable || !isEdit'>
...
export default {
  ...
  filters: {
    getTruckGpsUrl(truckNo) {
      var url = `/truck/truck-gps.html?truckLicenseNo=${truckNo}&queryNow=true`;
      console.log(url);
      return url;
    }
  },
          ...
          (lbsSuccess, lbsErr) => {
            if (lbsSuccess.content.length > 0) {
              ...
              LbsService.getAddress({
                ...
                this.truckGpsUrl = `/truck/truck-gps.html?truckLicenseNo=${truckLicenseNo}&queryNow=true`;
