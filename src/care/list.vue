...
<script type="text/ecmascript-6">
  ...
  import {getDetail, getColumn, list, getSearch, deleted, exportCsv, add, downloadErrorData, downloadTemplate } from '../../api/CareService';
  ...
  export default {
    ...
    data: () => {
      return {
        ...
        getSearch,
        objectName: '保养记录',
        addUrl: '/care/add.html',
        editUrl: '/care/add.html',
        listUrl: '/care/list.html',
        deleteFun: deleted,
        exportCsv,
        add,
        downloadErrorData,
        importUrl: `${ApiConst.apiMaintenaceDomain}/import/custom/care`,
