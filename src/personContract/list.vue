...
<template>
  <div>
    <ele-list :selectable="selectable" :operatable="operatable"
              ...
              <a class="el-button el-button--line" :href="contractUrl" slot="topRightFun" target="_blank" :download="contractName"  v-check-permission="'contract.download'">下载框架合同</a>
    </ele-list>
  </div>
</template>
...
<script type="text/ecmascript-6">
  ...
  import { getColumn, list, getSearch, deleted, exportCsv, add, downloadErrorData, downloadTemplate } from '../../api/PersonContractService.js';
  ...
  export default {
    ...
    data() {
      return {
        ...
        getSearch,
        objectName: '司机合同',
        addUrl: '/personContract/add.html',
        editUrl: '/personContract/add.html',
        listUrl: '/personContract/list.html',
        deleteFun: deleted,
        exportCsv,
        add,
        downloadErrorData,
