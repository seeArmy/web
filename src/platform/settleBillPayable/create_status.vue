...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      onGoList() {
        this.openWindow('/platform/settleBillPayable/list.html', '应付账单');
        // this.tips.status = false;
        // this.$message.info('去查看列表');
        // window.location.href = '/settleBillReceivable/list.html';
      },
      onGoView() {
        this.openWindow(`/platform/settleBillPayable/create.html?code=${this.tips.billCode}&editable=false`, '应付账单详情');
        // this.tips.status = false;
