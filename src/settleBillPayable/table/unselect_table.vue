...
<script>
  ...
  import { settlePayableSelectPayableWaybillList, settlePayableWaybillColumns, settlePayableWaybillSearch, settlePayableSelectWaybill } from '../../../api/SettleBillService';
  ...
  export default {
    ...
    methods: {
      ...
      getData() {
        ...
        settlePayableSelectPayableWaybillList(this.paramObj, (success, error) => {
          if (error) {
            that.loading = false;
            this.$message({
              type: 'error',
