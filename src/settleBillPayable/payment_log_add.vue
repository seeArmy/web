    ...
    <div class="form-page">
      <ele-form :domainObject="domainObject" ref="form"
        ...
        <payment-log-layout :isEdit="isEdit" :editable="editable" :objectName="objectName">
          ...
          <payment-relation-list slot="paymentRelationList"></payment-relation-list>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    data() {
      return {
        objectName: '付款记录',
        configUrl: `${ApiConst.apiSettleDomain}/detail_render_info/actualPayment/list`,
        domainObject: {},
