  ...
  <el-dialog :title="title" :visible.sync="dialog.show" size='large'>
    <el-form :model="dialog.data" label-width="100px" :inline="true" :rules="rules" ref="data">
      <el-row class="grey-section">
        <el-col :span="24">
          <label>承运商名称：</label>
          <span>{{dialog.data.carrierOrgName}}</span>
        </el-col>
        <el-col :span="8">
          <label>账单编号：</label>
        ...
        <el-col :span="8">
          <label>未付金额：</label>
          <span>¥<strong>{{dialog.data.unpaidAmount}}</strong>元</span>
        </el-col>
        <el-col :span="8">
          <label>应付金额：</label>
          <span>¥<strong>{{dialog.data.payableAmount}}</strong>元</span>
        </el-col>
        <el-col :span="8">
          <label>已付金额：</label>
          <span>¥<strong>{{dialog.data.paidAmount}}</strong>元</span>
        </el-col>
      </el-row>
