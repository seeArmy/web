    ...
    <el-form :inline="true">
      <div class="computed-component">
        ...
        <div class="computed-base-component">
          ...
          <div class="base-list">
            ...
            <div class="base-li">
              ...
              <span class="base-li-value">￥{{submitData.adjustmentQuotaAmount }}元</span>
            </div>
            <div class="base-li">
              <span class="base-li-label">应付调整比例金额总额：</span>
              <span class="base-li-value">￥{{submitData.adjustmentProportionAmount }}元</span>
            </div>
            <div class="base-li">
              <span class="base-li-label">应付运费小计总额：</span>
              <span class="base-li-value">￥{{submitData.freightSubtotalAmount}}元</span>
            </div>
            <div class="base-li end">
              <span class="base-li-label">含税应付运费小计总额：</span>
              <span class="base-li-value">￥{{submitData.taxFreightSubtotalAmount}}元</span>
            </div>
          </div>
        </div>
        <div class="computed-change-component">
          ...
          <div v-if="submitData.adjustmentWay==='quota'">
            <el-form-item label-width="100px" label="应收整单调整">
              <span v-if="!readonly">
                <el-input v-if='!readonly' :disabled="readonly" type="number" @change="onChangeBase" v-model="submitData.entireSingleAdjustment"
        ...
        <div class="computed-total">
          ...
          <span class="value">￥{{submitData.payableAmount}}元</span>
        </div>
      </div>
      ...
      onGetStatic() {
        return new Promise((resolve, reject) => {
          ...
          if (this.params.billCode) {
            ...
            // data.carrierOrgCode = this.params.clientOrgCode;
          }
