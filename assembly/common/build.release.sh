...
#npm run build:prod
npm run build production='轻量化平台&gatewayUrl=https://rltx2-yfb-gateway.rltx.com'
...
cp -r dist/production/* ${WEB_ROOT_DIR}
...
echo -e "\033[34m build production done.... \033[0m"
